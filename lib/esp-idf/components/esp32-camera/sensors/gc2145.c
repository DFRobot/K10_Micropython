...
static int set_framesize(sensor_t *sensor, framesize_t framesize)
{
    ...
    write_reg(sensor->slv_addr, 0x09, H8(row_s + 130));
    write_reg(sensor->slv_addr, 0x0a, L8(row_s + 130));
    write_reg(sensor->slv_addr, 0x0b, H8(col_s + 150));
    write_reg(sensor->slv_addr, 0x0c, L8(col_s + 150));
